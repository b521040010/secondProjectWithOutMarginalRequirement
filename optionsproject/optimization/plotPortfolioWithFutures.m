function [ fig ] = plotPortfolioWithFutures( date,instruments, quantities )
...
for i=1:nInstruments
    ...
    elseif (isa(instrument,'Future2'))
        ...
        askSizeFuture(j)=instrument.askSize;
        bidSizeFuture(j)=instrument.bidSize;
        j=j+1;
